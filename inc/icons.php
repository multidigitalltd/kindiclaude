...
function kindi_icon( string $name, string $class = '' ): string {
	...
	if ( null === $icons ) {
		...
		'filter' => array( 'stroke' => '#1B2A52', 'body' => '<path d="M4.5 5.5h15l-5.5 7v5.5l-4 1.6v-7.1z" fill="#E8F0FE" />' ),
		...
		'info' => array( 'stroke' => '#1B2A52', 'body' => '<circle cx="12" cy="12" r="8.5" fill="#E8F0FE" /> <circle cx="12" cy="8" r="1" fill="#E63946" stroke="none" /> <path d="M12 11v6" stroke="#E63946" stroke-width="1.6" />' ),
