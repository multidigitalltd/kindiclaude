		...
		'texts'    => array(
			...
			'sections' => array(
				'כללי'         => array(
					...
					'free_ship_exclude_cats' => array( 'type' => 'taxonomy_multi', 'label' => 'החרגת משלוח חינם — קטגוריות', 'help' => 'מוצרים בקטגוריות שתבחרו (וכל תת-הקטגוריות שלהן) לא יזכו במשלוח חינם, ללא קשר לסכום. השאירו ריק כדי לשמור על ההתאמה האוטומטית הקיימת לפי השם "ריהוט".' ),
