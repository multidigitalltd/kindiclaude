...
<section class="kindi-section kindi-store">
	...
	<div class="kindi-store__card">
		...
		<div class="kindi-store__media">
			...
			<img class="kindi-store__mascot animate-mascot" src="<?php echo esc_url( kindi_mascot_src( 'storeinfo_mascot', 'mascot/kindy-store-invite.webp' ) ); ?>" alt="" loading="lazy" decoding="async">
