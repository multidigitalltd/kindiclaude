...
<section class="kindi-section kindi-hero">
	...
	<div class="kindi-hero__grid">
		...
		<div class="kindi-hero__visual">
			...
			<img class="kindi-hero__mascot animate-mascot" src="<?php echo kindi_img( 'mascot/original.webp' ); ?>" width="520" height="520" fetchpriority="high" decoding="async" alt="קינדי מציג את עולם המוצרים בקינדר טויס — צעצועים, ילקוטים, יצירה ומשחקי קופסה">
