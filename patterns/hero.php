...
<section class="kindi-section kindi-hero">
	...
	<div class="kindi-hero__grid">
		...
		<div class="kindi-hero__visual">
			...
			<img class="kindi-hero__mascot animate-mascot" src="<?php echo kindi_img( 'kindy-hero.webp' ); ?>" width="520" height="520" alt="קינדי מציג את עולם המוצרים בקינדר טויס — צעצועים, ילקוטים, יצירה ומשחקי קופסה">
