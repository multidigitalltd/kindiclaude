...
?>
<!-- wp:html -->
<a class="kindi-float kindi-float--wa animate-bob" href="https://wa.me/972500000000" aria-label="צ'אט בוואטסאפ" target="_blank" rel="noopener"><?php echo kindi_icon( 'whatsapp', 'kindi-icon--3xl' ); // phpcs:ignore WordPress.Security.EscapeOutput ?></a>
